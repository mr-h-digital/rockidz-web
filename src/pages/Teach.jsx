  ...
  return (
    <ThemedPage variant="teach">
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        {showCreate && (
          <form onSubmit={handleCreate} className="mt-8 space-y-4 rounded-[2rem] border-4 border-white/70 bg-white/70 p-6">
            ...
            <button type="submit" disabled={creating} className="rounded-full bg-[#00c2ff] px-6 py-3 text-sm font-black uppercase tracking-wide text-white disabled:opacity-60">
              {creating ? 'Creating…' : 'Create activity draft'}
            </button>
          </form>
        )}
