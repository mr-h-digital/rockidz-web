  ...
  return (
    <ThemedPage variant="catalog">
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        {!courses && !error && <p className="mt-10 text-sm text-white/84">Scanning the galaxy for activities…</p>}
        {courses && courses.length === 0 && <p className="mt-10 text-sm text-white/84">New Rockidz adventures are docking soon.</p>}
